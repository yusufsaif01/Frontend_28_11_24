...
import { OtpForForgotPassword } from './otp-for-forgot-password.Service';
import { Router, ActivatedRoute } from '@angular/router';
import { AuthenticationService, untilDestroyed } from '@app/core';
@Component({
  selector: 'app-otp-for-forgot-password',
  templateUrl: './otp-for-forgot-password.component.html',
  styleUrls: ['./otp-for-forgot-password.component.scss']
})
export class OtpForForgotPasswordComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private _otpService: OtpForForgotPassword,
        ...
        response => {
          ...
          if (response.data) {
            ...
            this.router.navigate(
              [this.route.snapshot.queryParams.redirect || '/reset-password'],
              { replaceUrl: true }
            );
          }
        },

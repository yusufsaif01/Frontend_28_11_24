...
export class FrontendSidebarComponent implements OnInit {
  sidebarList: { link: string; name: string; imagePath: string }[] = [
    ...
    { link: './courses', name: 'Course', imagePath: 'assets/images/icons/sidebar/manage-chapter.png' },
    { link: './events', name: 'Events', imagePath: 'assets/images/icons/sidebar/manage-reports.png' },
    { link: './reports', name: 'Reports', imagePath: 'assets/images/icons/sidebar/manage-reports.png' },
    {
      link: './certficartion',
      name: 'Certificartion/Badges',
      imagePath: 'assets/images/icons/sidebar/manage-reports.png'
    },
    { link: './profile', name: 'Profile', imagePath: 'assets/images/icons/sidebar/user.png' }
  ];
